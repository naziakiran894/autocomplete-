...
export default function CustomizedHook() {
  const handleInputChange = (event) => {
    ...
    const hasMathSign = /[+\-*/=<>]/.test(inputValue);
  ...
  console.log(groupedOptions, value, "dfdf");
...
const top100Films = [
  ...
  { title: "Multiplication", calculation: "6 * 5" },
  { title: "Square Root", calculation: "sqrt(16)" },
  { title: "Division", calculation: "10 / 2" },
  { title: "Sine", calculation: "sin(45)" },
  { title: "Cosine", calculation: "cos(0)" },
